...
public class Volleyball extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTransaction.add(R.id.volleyballly, new Volleyball_tab_layout(), "abcd").commit();
        tb = (android.support.v7.widget.Toolbar) findViewById(R.id.volleyball_toolbar);

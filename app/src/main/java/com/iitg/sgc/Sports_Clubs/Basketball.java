...
public class Basketball extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTransaction.add( R.id.basketballly,new Basketball_tab_layout(),"abcd").commit();
        tb = (android.support.v7.widget.Toolbar) findViewById(R.id.basketball_toolbar);

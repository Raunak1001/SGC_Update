 ...
 */
public class Ribbon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTransaction.add(R.id.ribbonly, new Ribbon_tab_layout(), "abcd").commit();
        tb = (android.support.v7.widget.Toolbar) findViewById(R.id.ribbon_toolbar);

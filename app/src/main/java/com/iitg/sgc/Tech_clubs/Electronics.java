...
public class Electronics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTransaction.add(R.id.electronicsly, new Electronics_tab_layout(), "abcd").commit();
        tb = (android.support.v7.widget.Toolbar) findViewById(R.id.electronics_toolbar);

 ...
 */
public class FineArts extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb = (android.support.v7.widget.Toolbar) findViewById(R.id.finearts_toolbar);
        setContentView(R.layout.finearts);

        mFragmentManager = getSupportFragmentManager();
        mFragmentTransaction = mFragmentManager.beginTransaction();
        mFragmentTransaction.add(R.id.fineartsly, new FineArts_tab_layout(), "abcd").commit();
        tb = (android.support.v7.widget.Toolbar) findViewById(R.id.finearts_toolbar);
